...
public class StoreManager {
    ...
    /**
     * Constructor for store.StoreManager that creates new Inventory and StoreManager object
     */
    public StoreManager() {
     ...
     *
     * @param product  store.Product, the product being added to the inventory
